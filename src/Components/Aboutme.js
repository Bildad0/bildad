        ...
        <div className="flex  flex-col lg:flex-row justify-between">
          <div className="w-full lg:w-1/2 items-center " data-aos="fade-right"  >
            ...
            <p className="text-lg text-gray-400 " > Hello! My name is Bildad and I enjoy creating things that live on the
              internet. I Have Completed My College From Technical University of Mombasa(Kenya) In BsIT (Bachelor of Science in Information Technology) And Currently a Frontend React & Flutter developer  </p>
